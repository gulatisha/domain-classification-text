...
all_text = tfidf_vectorizer.fit_transform(all_text)
X= all_text.toarray()
...
print("Logisitic Regression Accuracy :",log_accuracy)
print("\n Multinomial Accuracy :",nb_accuracy)
print("\n LSVM Accuracy :",lsvm_accuracy)
...
print('Multinomial Accuracy :',nb_accuracy_2)

y_pred = lsvm.predict(X_test)
lsvm_accuracy_2 = accuracy_score(y_test,y_pred)
print('Linear SVM accuracy :',lsvm_accuracy_2)
...
topic_list,coherence_value_list = compute_coherence_values(dictionary,doc_term_matrix,doc_clean,start=1,limit=41,step=5)
